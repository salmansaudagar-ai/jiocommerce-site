  ...
  return (
    <section className="py-20 lg:py-32 bg-gradient-to-r from-jio-purple/10 to-jio-blue/10">
      <div className="max-w-2xl mx-auto px-6">
        ...
        >
          {/* Icon */}
          <div className="inline-block mb-6 p-3 bg-jio-purple/20 rounded-full">
            <div className="text-4xl">📬</div>
          </div>

          {/* Heading */}
          <h2 className="text-3xl md:text-4xl font-bold text-jio-navy mb-4">
          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-lg border-2 border-gray-300 focus:border-jio-purple focus:outline-none transition-colors disabled:bg-gray-100 disabled:cursor-not-allowed font-medium"
              />
              <motion.button
                type="submit"
